 ...
 *
 *  An operation sample of PCA9956A 24-channel Fm+ I2C-bus 57mA/20V constant
 * current LED driver. mbed accesses the PCA9956A registers through I2C.
 *
 *  @class   PCA9956A
...
/** PCA9956A class
 *
 *  This is a driver code for the PCA9956A 24-channel Fm+ I2C-bus 57mA/20V
 * constant current LED driver. This class provides interface for PCA9956A
 ...
 *  #include "PCA9956A.h"
 *
 *  PCA9956A    led_cntlr( p28, p27, 0x02 );    //  SDA, SCL,
...
public:
    ...
    /** Create a PCA9956A instance connected to specified I2C pins with
     * specified address
     *
     ...
     */
    PCA9956A(PinName i2c_sda, PinName i2c_scl,
     ...
     * (representing on 0%) and 1.0f (representing on 99.6%).
     *
     *  @note
